...
STATIONS: list[dict[str, Any]] = [
    ...
    _s(
        ...
        species=["spring_chinook", "summer_chinook", "fall_chinook", "sockeye",
    ...
    _s(
        ...
        species=["spring_chinook", "fall_chinook", "coho",
                 "summer_steelhead", "winter_steelhead"],
        reach_type="freeflowing",
    ...
    _s(
        ...
        species=["spring_chinook", "fall_chinook", "coho", "summer_steelhead",
                 "winter_steelhead"],
        reach_type="confluence",
